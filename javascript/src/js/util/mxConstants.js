 ...
 var mxConstants =
 {
	...
	*/
    ...
    /**
	 ...
	 /**
	  * Variable: SHAPE_CRAYONSCRIPT_CODE
	  *
	  * Name under which <mxCrayonScriptCodeShape> is registered in <mxCellRenderer>.
	  * Default is rectangle.
	  */
	 SHAPE_CRAYONSCRIPT_CODE: 'crayonscript_code',

	 /**
	  * Variable: SHAPE_CRAYONSCRIPT_DATA
	  *
	  * Name under which <mxCrayonScriptDataShape> is registered in <mxCellRenderer>.
	  * Default is rectangle.
	  */
	 SHAPE_CRAYONSCRIPT_DATA: 'crayonscript_data',
